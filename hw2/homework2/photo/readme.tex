...
\begin{pmatrix}
  ...
  \end{pmatrix}=\begin{pmatrix}
    ...
    \end{pmatrix}\begin{pmatrix}
      ...
      \end{pmatrix}
$$
只需要在图\ref{fig:3}(a)红线所围成的元胞中找到一个极小值点$x_0,y_0$即可，其余极小值点由$x_m=x_0+2 m\pi,y_n=y_0+2 n \pi,(m,n) \in \mathbb{Z}$给出。
...
\begin{breakablealgorithm}
  ...
  \begin{algorithmic}
    \Function{GradiantDescent}{$X0,g,dg,ap,tol,maxIter$}
      ...
      \For{$i \gets 1$ \To $maxIter$}
        \State $dX \gets$ $\lambda dg(X)$ \Comment{Calculate the gradient at current $X$}
